...
3. Open the `Exercicios` folder in your IDE (my personal choice is [PyCharm](https://www.jetbrains.com/pycharm/)). 
4. Set Python 3.7.0 as the project's interpreter.

You are ready to go now :+1:!

I hope you can enjoy and learn with the beauty of Machine Learning as I did :punch:!